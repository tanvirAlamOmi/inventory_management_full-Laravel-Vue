...
<div class="row">
        ...
        <div class="well" style="box-shadow: 0 5px 15px rgba(0,0,0,.5">
            ...
            <form method="POST" action="/stocks/store" class="form-horizontal" >
                @csrf
          ...
          <div class="form-group">
                <label for="inputEmail3"  class="col-md-2 col-form-label text-md-right">Vendor</label>
                    <div class="col-sm-10">
                        {{-- <input name="vendor"type="text" class="form-control" required=""> --}}
            ...
            {{-- <div class="form-group">
                <label for="inputEmail3"  class="col-md-2 col-form-label text-md-right">Chalan</label>
                    <div class="col-sm-10">
                        <input name="description" cols="30" rows="10" type="text" class="form-control" required="">
                    </div>
            </div> --}}
            ...
            <div class="form-group">
                <label for="inputEmail3"  class="col-md-2 col-form-label text-md-right">Quantity Type</label>
                    {{-- <div class="col-sm-10">
                        <input name="quantity_type"  type="text" class="form-control" required="">
                    </div> --}}
                    <div class="col-sm-10">
           ...
           --}}
            <div class="form-group">
                <label for="inputEmail3"  class="col-md-2 col-form-label text-md-right">Stock Quantity</label>
                    <div class="col-sm-10">
                        <input name="stock_quantity"  type="number" step="1.0" class="form-control" required="">
                    </div>
            </div>
          
            <div class="form-group">
                <label for="inputEmail3"  class="col-md-2 col-form-label text-md-right">Buying Price</label>
                    <div class="col-sm-10">
                        <input name="buying_price"  type="number" step="0.25"  class="form-control" required="">
                    </div>
            </div>
